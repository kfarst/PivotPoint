...
@synthesize detailViewController, utilities, fetchedResultsController, managedObjectContext;
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Event" inManagedObjectContext:[utilities managedObjectContext]];
...
- (void)dealloc {
	...
	[utilities release], utilities = nil;
